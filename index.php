    ...
    <main class="main" id="top">
     ...
     <?php include 'inc/navbar.php'; ?>
      ...
      <section class="pb-6">
        ...
        <div class="container">
          <div class="row flex-center">
            <div class="col-lg-6 col-md-5 order-md-1"><img class="img-fluid" src="assets/img/illustrations/img.jpg" alt="" /></div>
            <div class="col-md-7 col-lg-6 mt-5 text-center text-md-start">
              <h1 class="fw-medium">Invigilation Allocation System<br />  <span class="fw-bold"></span></h1>
              <p class="mt-3 mb-4"> This system automate the process of allocating the duties to achieve efficient coordination of examination management process in an educational organization. <span class="fw-medium"> </span> </p><a class="btn btn-lg btn-danger hover-top btn-glow" href="#">Get Started </a>
            </div>
          </div>
      ...
      <section class="bg-200 pt-9 pb-0">
        ...
        <div class="container">
          <div class="row">
            <div class="col-12 col-lg-4 mb-3"><a href="#"><img class="d-inline-block align-middle" src="assets/img/icons/logo.png" alt="" width="30" /><span class="d-inline-block text-1000 fs-1 ms-2 fw-medium lh-base">Invigilation Allocation System</a>
              <p class="my-3"> <span class="fw-medium">PMB 106, Kaduna Polytechnic, Behinde Education-Tech, Kaduna Nigeria </p>
              ...
              <p class="text-400 my-3">&copy; 2022 Kaduna Polytechnic</p>
            </div>
            <hr class="opacity-25" />
            <div class="text-400 text-center">
              <p>This project was made with &nbsp;
                ...
                </svg>&nbsp;by&nbsp;<a class="text-900" href="https://themewagon.com/" target="_blank"> ND-II Students</a>
              </p>
            </div>
          </div>
        </div><!-- end of .container-->
