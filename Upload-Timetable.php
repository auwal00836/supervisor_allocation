          ...
          <div class="row justify-content-center">
            <div class="col-md-12 pt-0 px-md-2 px-lg-3">
              ...
              <div class="card " style=" min-height: 450px;">
                <div class="text-center mt-2"><h2>Upload TimetTable</h2></div>
                <hr>
                <div class="card-body">
                  ...
                  <form method="POST" enctype="multipart/form-data">
                    <div class="container col-md-6 offset-sm-3">
                      ...
                      <div class="form-group mb-3">
                        <button class="btn btn-danger rounded-2 order-0 form-control" type="submit" name="btn_upload_timetable">Upload</button>
                      </div>
